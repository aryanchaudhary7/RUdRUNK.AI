!function(c, It, bt, l) {
    ...
    function Kt(t, e, n) {
        ...
        function(t, e) {
            var n = t.session
              , i = e.pointers
              , r = i.length;
            n.firstInput || (n.firstInput = Dt(e)),
            r > 1 && !n.firstMultiple ? n.firstMultiple = Dt(e) : 1 === r && (n.firstMultiple = !1);
            var s = n.firstInput
              , o = n.firstMultiple
            ...
            e.overallVelocity = w(v.x) > w(v.y) ? v.x : v.y,
            e.scale = o ? function(t, e) {
            ...
            var I = t.element;
            Ct(e.srcEvent.target, I) && (I = e.srcEvent.target),
            e.target = I
        }(t, n),
    ...
    function re(t, e) {
        ...
        return e & (h | p) && (n = St(n.concat(i), "identifier", !0)),
        [n, i]
    }
    function K() {
        this.evTarget = Oe,
    ...
    function se(t, e) {
        ...
        if (e & (a | O) && 1 === n.length)
            ...
            [n, n];
        var r, s, o = B(t.changedTouches), u = [], T = this.target;
        ...
        e === a)
            for (r = 0; r < s.length; )
                ...
                r++;
        for (r = 0; r < o.length; )
            i[o[r].identifier] && u.push(o[r]),
            e & (h | p) && delete i[o[r].identifier],
            r++;
    ...
    function oe(t, e) {
        t & a ? (this.primaryTouch = e.changedPointers[0].identifier,
        Mt.call(this, e)) : t & (h | p) && Mt.call(this, e)
    }
    function Mt(t) {
    ...
    function _(t) {
        ...
        this.id = ve++,
        this.manager = null,
        this.options.enable = _t(this.options.enable, !0),
        this.state = st,
        this.simultaneous = {},
        this.requireFail = []
    }
    ...
    function C(t, e) {
        return (e = e || {}).recognizers = _t(e.recognizers, C.defaults.preset),
        new gt(t,e)
    }
    function gt(t, e) {
        this.options = S({}, C.defaults, e || {}),
        ...
        Xt(this, !0),
        A(this.options.recognizers, function(n) {
            var i = this.add(new n[0](n[1]));
            n[2] && i.recognizeWith(n[2]),
            n[3] && i.requireFailure(n[3])
        }, this)
    }
    function Xt(t, e) {
        var i, n = t.element;
    ...
    var S, Yt = ["", "webkit", "Moz", "MS", "ms", "o"], le = It.createElement("div"), pe = "function", X = Math.round, w = Math.abs, Tt = Date.now;
    ...
    d.prototype = {
        handler: function() {},
        init: function() {
            this.evEl && j(this.element, this.evEl, this.domHandler),
            this.evTarget && j(this.target, this.evTarget, this.domHandler),
            this.evWin && j(Pt(this.element), this.evWin, this.domHandler)
        },
        destroy: function() {
            this.evEl && G(this.element, this.evEl, this.domHandler),
            this.evTarget && G(this.target, this.evTarget, this.domHandler),
            this.evWin && G(Pt(this.element), this.evWin, this.domHandler)
        }
    };
    var Ie = {
        mousedown: a,
    ...
    c.MSPointerEvent && !c.PointerEvent && (Ht = "MSPointerDown",
    Lt = "MSPointerMove MSPointerUp MSPointerCancel"),
    f(at, d, {
        handler: function(t) {
            var e = this.store
              , n = !1
            ...
            r & a && (0 === t.button || o) ? 0 > u && (e.push(t),
            u = e.length - 1) : r & (h | p) && (n = !0),
            0 > u || (e[u] = t,
    ...
    f(Rt, d, {
        handler: function(t) {
            var e = Pe[t.type];
            if (e === a && (this.started = !0),
            this.started) {
                var n = re.call(this, t, e);
                e & (h | p) && n[0].length - n[1].length == 0 && (this.started = !1),
                this.callback(this.manager, e, {
                    pointers: n[0],
                    changedPointers: n[1],
                    pointerType: F,
    ...
    pt.prototype = {
        set: function(t) {
            t == Gt && (t = this.compute()),
            jt && this.manager.element.style && rt[t] && (this.manager.element.style[Vt] = t),
    ...
    _.prototype = {
        ...
        recognizeWith: function(t) {
            if (z(t, "recognizeWith", this))
                return this;
            var e = this.simultaneous;
            return e[(t = Q(t, this)).id] || (e[t.id] = t,
            t.recognizeWith(this)),
            this
        },
        dropRecognizeWith: function(t) {
            return z(t, "dropRecognizeWith", this) || (t = Q(t, this),
            delete this.simultaneous[t.id]),
            this
        },
        requireFailure: function(t) {
            if (z(t, "requireFailure", this))
                return this;
            var e = this.requireFail;
            return -1 === N(e, t = Q(t, this)) && (e.push(t),
            t.requireFailure(this)),
            this
        },
        dropRequireFailure: function(t) {
            if (z(t, "dropRequireFailure", this))
                return this;
            t = Q(t, this);
        ...
        emit: function(t) {
            ...
            var n = this
              , i = this.state;
            D > i && e(n.options.event + zt(i)),
            e(n.options.event),
            t.additionalEvent && e(t.additionalEvent),
            i >= D && e(n.options.event + zt(i))
        },
        tryEmit: function(t) {
        ...
        canEmit: function() {
            for (var t = 0; t < this.requireFail.length; ) {
                if (!(this.requireFail[t].state & (E | st)))
                    return !1;
                t++
            }
            return !0
        ...
        recognize: function(t) {
            var e = S({}, t);
            return ht(this.options.enable, [this, e]) ? (this.state & (P | V | E) && (this.state = st),
            this.state = this.process(e),
            void (this.state & (m | Y | D | V) && this.tryEmit(e))) : (this.reset(),
            void (this.state = E))
        },
        process: function(t) {},
    ...
    f(tt, g, {
        ...
        directionTest: function(t) {
            var e = this.options
              ...
              , s = t.deltaX
              , o = t.deltaY;
            return r & e.direction || (e.direction & y ? (r = 0 === s ? nt : 0 > s ? q : W,
            n = s != this.pX,
    ...
    f(vt, _, {
        ...
        process: function(t) {
            ...
            if (this._input = t,
            !i || !n || t.eventType & (h | p) && !r)
                this.reset();
            else if (t.eventType & a)
                this.reset(),
                this._timer = ot(function() {
                    this.state = P,
                    this.tryEmit()
                }, e.time, this);
        ...
        emit: function(t) {
            this.state === P && (t && t.eventType & h ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = Tt(),
    ...
    f(mt, g, {
        ...
        attrTest: function(t) {
            ...
            return n & (y | R) ? e = t.overallVelocity : n & y ? e = t.overallVelocityX : n & R && (e = t.overallVelocityY),
            this._super.attrTest.call(this, t) && n & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && w(e) > this.options.velocity && t.eventType & h
        },
        emit: function(t) {
    ...
    f(et, _, {
        ...
        emit: function() {
            this.state == P && (this._input.tapCount = this.count,
            this.manager.emit(this.options.event, this._input))
        }
    }),
    C.VERSION = "2.0.7",
        ...
        recognize: function(t) {
            ...
            if (!e.stopped) {
                ...
                for (var s = 0; s < i.length; )
                    ...
                    !r && n.state & (m | Y | D) && (r = e.curRecognizer = n),
                    s++
            }
        },
        get: function(t) {
    ...
    (void 0 !== c ? c : "undefined" != typeof self ? self : {}).Hammer = C,
    "function" == typeof define && define.amd ? define(function() {
        return C
    }) : "undefined" != typeof module && module.exports ? module.exports = C : c.Hammer = C
}(window, document);
